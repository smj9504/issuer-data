...
charts and scans differ without limit. "Did we get the fields we came for, each
traced back to its own page and line" is bounded and checkable, so that is the
